...
class MainWindow(qtw.QMainWindow):
    def __init__(self):
        ...
        category_1 = qtw.QTreeWidgetItem(self.tree_widget, ["Apples", "Edible fruit produced by an apple tree"])
        apple_list =[["Braeburn", "Yellow with red stripes or blush",
                     "icons/braeburn.png"], ["Empire", "Solid red", "icons/empire.png"],
                     ["Ginger Gold", "Green-yellow", "icons/ginger_gold.png"]]
        for i in range(len(apple_list)):
            category_1_child = qtw.QTreeWidgetItem(
                apple_list[i][:2])
